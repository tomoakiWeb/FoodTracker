...
//  FoodTracker
//
//  Created by 三浦　知明 on 2019/12/10.
...
//            button.accessibilityLabel = "Set \(index + 1) star rating"
            ...
            button.addTarget(self, action: #selector(RatingController.ratingButtonTapped), for: .touchUpInside)
            //add the button ths stack
